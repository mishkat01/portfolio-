    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 border border-gray-200 dark:border-gray-700">
        <form action="{{ route('admin.roles.update', $role->id) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="name" id="name" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-900 dark:border-gray-600 dark:text-white" required value="{{ old('name', $role->name) }}">
            ...
            <div class="flex justify-end pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <button type="submit" class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 shadow-sm">Update Role</button>
            </div>
        </form>
    </div>
</div>
