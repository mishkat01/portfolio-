        ...
        <form action="{{ route('admin.portfolio.skills.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="proficiency" id="proficiency" value="{{ old('proficiency', 50) }}" min="0" max="100" required
                        class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                </div>
                ...
                <div>
                    ...
                    <div class="flex">
                        <input type="color" id="color" name="color" value="{{ old('color', '#3b82f6') }}" class="h-10 w-10 border border-gray-300 rounded mr-2 p-1">
                        <input type="text" name="color" value="{{ old('color', '#3b82f6') }}" class="flex-1 rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    </div>
                </div>
